...
struct TestWizardView: View {
    ...
    private var answerStep: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            HStack(spacing: 10) {
                inputModeButton(icon: "text.cursor",     label: "Text",  color: stepAccent) { showingTextAdd = true }
                inputModeButton(icon: "camera.viewfinder", label: "Image", color: .purple)  { showingImageActionSheet = true }
    ...
    private func inputModeButton(icon: String, label: String, color: Color, action: @escaping () -> Void) -> some View {
